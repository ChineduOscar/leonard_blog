  ...
  return (
    <main>
      <div className='about_banner'>
        <div>
          <div className='page_name'>About</div>
        </div>
      </div>
      ...
      <div className='section2_about'>
        <div className='about_text'>
          <img
            ...
            alt='author image'
            className='home_about_image inline'
          />
          ...
          <div className='paragraph'>
            ...
            Union of Poets (WUP) published by Atunis Poetry in 2016 .
          </div>
          <div className='paragraph'>
            He also became the coordinator of the Creative Writers Association
          ...
          The journey of this writer became even more resilient when he embarked
          ...
          Onuzulike, Etc.
          <div className='paragraph'>
            Despite Leonard’s academic endowment in Political and International
            ...
            What has Leo not done for his dream?
          </div>
